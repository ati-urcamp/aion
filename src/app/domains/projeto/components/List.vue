<script>
  ...
  export default {
    ...
    async mounted () {
      ...
      bus.$emit('list-init', { domain: 'projeto', relations: ['cliente', 'tipo', 'situacao'] }, () => {
    ...
    methods: {
      ...
      onFilter () {
        ...
        if (this.filters.cliente) {
          searchData.ref_cliente = { '=': this.filters.cliente }
        }

        if (this.filters.tipo) {
          searchData.ref_projeto_tipo = { '=': this.filters.tipo }
        }

        if (this.filters.situacao) {
          searchData.ref_projeto_situacao = { '=': this.filters.situacao }
        }
...
<template>
    <div class="page-content">
        ...
        <app-page-header store-route-name="projeto.create"/>
                    ...
                    <table class="v-datatable v-table theme--light">
                        ...
                        <tr v-for="item in listStore.listData" :key="`item-${item.id}`">
                            ...
                            <td>
                                ...
                                <strong>Resp.:</strong> {{item.cliente.responsavel}}
                            </td>
                            ...
                            <td class="list-table-nowrap">
                                <div class="btn-actions">
                                    <ListEditButton route-name="projeto.edit" :item="item" domain="projeto"/>
                                    <ListDeleteButton :item="item" domain="projeto"/>
                                </div>
                            </td>
                        </tr>
                        </tbody>

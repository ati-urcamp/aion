<script>
  ...
  export default {
    ...
    mounted () {
      ...
      bus.$emit('list-init', { domain: 'cliente' }, () => {
...
<template>
    <div class="page-content">
        ...
        <app-page-header store-route-name="cliente.create"/>
                ...
                <div class="v-table__overflow">
                    <table class="v-datatable v-table theme--light">
                        ...
                        <tr>
                            ...
                            <th class="column">Responsável</th>
                        ...
                        <tr v-for="item in listStore.listData" :key="`item-${item.id}`">
                            ...
                            <td class="list-table-nowrap">
                                <div class="btn-actions">
                                    <ListEditButton route-name="cliente.edit" :item="item" domain="cliente"/>
                                    <ListDeleteButton :item="item" domain="cliente"/>
                                </div>
                            </td>
                        </tr>
                        </tbody>

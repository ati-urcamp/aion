<script>
  ...
  export default {
    ...
    mounted () {
      ...
      bus.$emit('list-init', { domain: 'projeto-situacao' }, () => {
...
<template>
    <div class="page-content">
        ...
        <app-page-header store-route-name="projeto-situacao.create"/>
                        ...
                        <tr v-for="item in listStore.listData" :key="`item-${item.id}`">
                            ...
                            <td class="list-table-nowrap">
                                <div class="btn-actions">
                                    <ListEditButton route-name="projeto-situacao.edit" :item="item"
                                                    domain="projeto-situacao"/>
                                    <ListDeleteButton :item="item" domain="projeto-situacao"/>
                                </div>
                            </td>
                        </tr>
                        </tbody>

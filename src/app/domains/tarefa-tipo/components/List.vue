<script>
  ...
  export default {
    ...
    mounted () {
      ...
      bus.$emit('list-init', { domain: 'tarefa-tipo' }, () => {
...
<template>
    <div class="page-content">
        ...
        <app-page-header store-route-name="tarefa-tipo.create"/>
                ...
                <div class="v-table__overflow">
                    <table class="v-datatable v-table theme--light">
                        ...
                        <tr>
                            ...
                            <th class="column">Esforço padrão</th>
                        ...
                        <tr v-for="item in listStore.listData" :key="`item-${item.id}`">
                            <td>{{item.id}}</td>
                            <td>{{item.nome}}</td>
                            <td>{{item.esforco_padrao}}</td>
                            <td>
                                <span class="v-swatches-label" :style="{'background-color': item.cor}"></span>
                            </td>
                            <td class="list-table-nowrap">
                                <div class="btn-actions">
                                    <ListEditButton route-name="tarefa-tipo.edit" :item="item"
                                                    domain="tarefa-tipo"/>
                                    <ListDeleteButton :item="item" domain="tarefa-tipo"/>
                                </div>
                            </td>
                        </tr>
                        </tbody>

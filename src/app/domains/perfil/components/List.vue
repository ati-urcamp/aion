<script>
  ...
  export default {
    ...
    mounted () {
      ...
      bus.$emit('list-init', { domain: 'perfil' }, () => {
...
<template>
    <div class="page-content">
        ...
        <app-page-header store-route-name="perfil.create"/>
                        ...
                        <tr v-for="item in listStore.listData" :key="`item-${item.id}`">
                            ...
                            <td class="list-table-nowrap">
                                <div class="btn-actions">
                                    <ListEditButton route-name="perfil.edit" :item="item" domain="perfil"/>
                                    <ListDeleteButton :item="item" domain="perfil"/>
                                </div>
                            </td>
                        </tr>
                        </tbody>

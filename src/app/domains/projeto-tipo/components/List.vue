<script>
  ...
  export default {
    ...
    mounted () {
      ...
      bus.$emit('list-init', { domain: 'projeto-tipo' }, () => {
...
<template>
    <div class="page-content">
        ...
        <app-page-header store-route-name="projeto-tipo.create"/>
                        ...
                        <tr v-for="item in listStore.listData" :key="`item-${item.id}`">
                            ...
                            <td class="list-table-nowrap">
                                <div class="btn-actions">
                                    <ListEditButton route-name="projeto-tipo.edit" :item="item"
                                                    domain="projeto-tipo"/>
                                    <ListDeleteButton :item="item" domain="projeto-tipo"/>
                                </div>
                            </td>
                        </tr>
                        </tbody>
